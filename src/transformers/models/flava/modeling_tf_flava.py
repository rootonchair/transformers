...
from ...modeling_tf_utils import TFPreTrainedModel, find_pruneable_heads_and_indices, prune_linear_layer
from ...utils import (
    ModelOutput,
...
TF_FLAVA_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "facebook/flava-full",
...
@dataclass
class TFFlavaModelOutput(ModelOutput):
    """
    ...
    image_output: Optional[TFBaseModelOutputWithPooling] = None
    text_embeddings: Optional[tf.Tensor] = None
    text_output: Optional[TFBaseModelOutputWithPooling] = None
    multimodal_embeddings: Optional[tf.Tensor] = None
    multimodal_output: Optional[TFBaseModelOutputWithPooling] = None
...
@dataclass
class TFFlavaLosses(ModelOutput):
    ...
    mim: Optional[tf.Tensor] = None
    mlm: Optional[tf.Tensor] = None
    itm: Optional[tf.Tensor] = None
    global_contrastive: Optional[tf.Tensor] = None
    mmm_image: Optional[tf.Tensor] = None
    mmm_text: Optional[tf.Tensor] = None
...
@dataclass
class TFFlavaForPreTrainingOutput(ModelOutput):
    """
    ...
    multimodal_embeddings: Optional[tf.Tensor] = None
    multimodal_output: Optional[TFBaseModelOutputWithPooling] = None
    image_masked_embeddings: Optional[tf.Tensor] = None
    image_masked_output: Optional[TFBaseModelOutputWithPooling] = None
    text_masked_embeddings: Optional[tf.Tensor] = None
    text_masked_output: Optional[TFBaseModelOutputWithPooling] = None
    multimodal_masked_embeddings: Optional[tf.Tensor] = None
    multimodal_masked_output: Optional[TFBaseModelOutputWithPooling] = None
    mim_logits: Optional[tf.Tensor] = None
    mlm_logits: Optional[tf.Tensor] = None
    itm_logits: Optional[tf.Tensor] = None
    contrastive_logits_per_image: Optional[tf.Tensor] = None
    contrastive_logits_per_text: Optional[tf.Tensor] = None
    mmm_image_logits: Optional[tf.Tensor] = None
    mmm_text_logits: Optional[tf.Tensor] = None
...
class FlavaImageEmbeddings(tf.keras.layers.Layer):
    """
